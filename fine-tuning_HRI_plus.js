    ...
    constructor() {
        ...
        const getModelConfig = (type) => {
            if (typeof MODEL_CONFIGS !== 'undefined') {
                ...
                return {
                    model: fallbackModels[type] || 'Qwen/QwQ-32B',
...
按回车继续。`;
    ...
    generateTrialsForBlock(blockType, items, startTrialNum) {
        ...
        if (typeof MODEL_CONFIGS !== 'undefined') {
            ...
            modelConfigs = {
                polite: {
                    model: 'ft:LoRA/Qwen/Qwen2.5-32B-Instruct:unyu3efqww:polite_infoseeking_746:kvygxnperqkxdrasgapc',
                ...
                impolite: {
                    model: 'ft:LoRA/Qwen/Qwen2.5-32B-Instruct:unyu3efqww:impolite_info_950:xyyzcufgydbjrvqchxpk',
